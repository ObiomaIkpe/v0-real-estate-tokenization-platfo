export const RealEstateDAppAddress =
  "0xEd27133B24A9cDf08E2a9F05D4ba2B5f323E2dE1";

export const RealEstateDAppABI = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: "FractionalAssetDoesNotExist",
    type: "error",
  },
  {
    inputs: [],
    name: "FractionalizedAssetWithBuyers",
    type: "error",
  },
  {
    inputs: [],
    ...
    outputs: [
      {
        ...
        internalType: "struct RealEstateDApp.RealEstateAsset[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct RealEstateDApp.FractionalBuyer[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct RealEstateDApp.Seller",
        name: "",
        type: "tuple",
      },
    ],
