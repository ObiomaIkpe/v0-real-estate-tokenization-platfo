      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Meet real investors from around the world who are building wealth
            through fractional real estate ownership, starting with as little as
            $10 and earning passive income from premium properties globally.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-12">
          ...
          <Card className="border-[#2d3748] text-center">
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-bold text-[#2d3748]">
                {globalStats.countriesRepresented}
              </p>
          ...
          <Card className="border-[#2d3748] text-center">
            <CardContent className="p-6">
              ...
              <p className="text-2xl font-bold text-[#2d3748]">
                {globalStats.propertiesTokenized}
              </p>
        ...
        <div className="mt-12 text-center bg-gradient-to-r from-[#2d3748] to-[#4a5568] text-white p-8 rounded-lg">
          ...
          <p className="text-gray-200 mb-6 max-w-2xl mx-auto">
            Start your real estate investment journey with as little as $100.
            Join thousands of investors from around the world building wealth
            through fractional property ownership.
          </p>
          <div className="flex gap-4 justify-center">
            <Button className="bg-[#d69e2e] hover:bg-[#b7791f] text-white px-8 py-3">
