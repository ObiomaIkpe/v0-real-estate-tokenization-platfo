          ...
          <TabsContent value="pending" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-slate-600">Review and approve new property submissions</p>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex space-x-4">
                          ...
                          <div className="flex-1">
                            <h3 className="text-lg font-semibold text-slate-900 mb-1">{asset.title}</h3>
                            <p className="text-slate-600 mb-2">{asset.location}</p>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium">${(asset.requestedValue / 1000000).toFixed(1)}M</p>
                              </div>
                              <div>
                                <p className="text-slate-600">Min Investment</p>
                                <p className="font-medium">${asset.minInvestment}</p>
                              </div>
                              <div>
                                <p className="text-slate-600">Expected Yield</p>
                                <p className="font-medium">{asset.expectedYield}%</p>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <TabsContent value="active" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-slate-600">Monitor live property performance</p>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {adminData.activeProperties.map((property) => (
                    <div key={property.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="text-lg font-semibold text-slate-900 mb-1">{property.title}</h3>
                          <p className="text-slate-600 mb-3">{property.location}</p>
                          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                            <div>
                              <p className="text-slate-600">Total Value</p>
                              <p className="font-medium">${(property.totalValue / 1000000).toFixed(1)}M</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {Math.round((property.tokensSold / property.totalTokens) * 100)}%
                              </p>
                            </div>
                          </div>
                        </div>
